...
public class Example6_Progress : MonoBehaviour
{
    ...
    private void Run()
    {
        ...
        {
            var record = CKRecord.initWithRecordType("BigFile");
        ...
        var op = CKModifyRecordsOperation.initWithRecordsToSave(records, null);
    ...
    private void DeleteRecords()
    {
        ...
        var op = CKModifyRecordsOperation.initWithRecordsToSave(null, records.Select(r => r.RecordID).ToArray());
        op.Configuration.QualityOfService = NSQualityOfService.UserInitiated;
